...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <span class="brand-text font-weight-bold">TUKO APP</span>
    </a>
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">
            @if(Session::has('ambilUser') && Session::get('ambilUser')->nama)
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('formhitung')}}" class="nav-link {{ Request::routeIs('formhitung') ? 'active' : '' }}">
                <i class="nav-icon fas fa-th"></i>
                <p> 
                  Form Hitung
                </p>
              ...
              <li class="nav-item">
                <a href="{{route('datagempa')}}" class="nav-link {{ Request::routeIs('datagempa') ? 'active' : '' }}">
                <i class="nav-icon fas fa-th"></i>
                <p> 
                  Data Gempa
                </p>
